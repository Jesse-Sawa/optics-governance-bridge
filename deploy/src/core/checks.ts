...
export async function checkCoreDeploy(
  ...
  console.log(`\nChecking core deploy for ${deploy.chain.name}:`)

  console.log('not asserting home beacon proxy')
  // // Home upgrade setup contracts are defined
  // assertBeaconProxy(deploy.contracts.home!);

  console.log('not asserting updaterManager is set on Home')
  ...
  if (remoteDomains.length > 0) {
    console.log('not asserting replicas to same implementation and upgradeBeacon ')
  ...
  console.log('not asserting governor is set on governor chain, empty on others')
  ...
  console.log('not asserting home is set on xAppConnectionManager')
  ...
  console.log('not asserting home owner is equal to governor address')
  ...
  console.log('not checking verification input for home contract')
  // checkVerificationInput(
  //   deploy,
  //   'Home Implementation',
  ...
  if (remoteDomains.length > 0) {
    console.log('not checking verification input for replica contract')
    // checkVerificationInput(
    //   deploy,
